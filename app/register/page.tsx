            ...
            >
                ...
                <div className="border border-zinc-800/80 bg-zinc-900/60 backdrop-blur-xl rounded-2xl p-8 shadow-[0_0_50px_-12px_rgba(16,185,129,0.12)] relative overflow-hidden">
                    ...
                    <div className="space-y-1 mb-6 text-center">
                        <h2 className="text-xl font-bold tracking-tight text-zinc-100">Create an Account</h2>
                        <p className="text-sm text-zinc-400">Join GeoSmart to start managing your premium projects</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <p className="text-center text-sm text-zinc-400 mt-6">
                            ...
                            <Link href="/login" className="text-emerald-500 hover:text-emerald-400 font-medium transition-colors hover:underline">
                                Login here
                            </Link>
                        </p>
                    </form>
