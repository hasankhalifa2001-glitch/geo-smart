          ...
          <div className="flex items-center gap-4">
            ...
            {isLoggedIn ? (
              <div className="flex items-center gap-4">
                ...
                <div className="relative" ref={dropdownRef}>
                  ...
                  >
                    ...
                    <HugeiconsIcon icon={ArrowDown01Icon} className={cn("size-3.5 text-slate-500 transition-transform duration-200", dropdownOpen && "rotate-180")} />
                  </button>
              ...
              <div className="flex items-center gap-4">
                <Link
                  href="/login"
                  className="text-zinc-500 hover:text-zinc-950 dark:text-zinc-400 dark:hover:text-zinc-100 font-medium text-sm transition-colors cursor-pointer"
                >
                  Log In
                </Link>
                <Link href="/calculator/map">
